...
def interactive_broker_connection():

	IBKR_user_token = "CHANGE HERE" #add your IBKR token here
	IBKR_user_query = "CHANGE HERE" #add your query ID here
	...
	def fetch_IBKR_orders(IBKR_user_token, IBKR_user_query):
	    ...
	    if page_content:
	        ...
	        if IBKR_code:
	            ...
	            print("====This URL retrieves query data information====")
	            ...
	            if IBKR_user_orders:
	                ...
	                print("====Check the generate file orders.csv=======")
